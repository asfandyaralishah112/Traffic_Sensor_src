...
void initVL53()
{
  ...
  myImager.setIntegrationTime(20); // v1.0.037: Improved sensitivity for shorter/small targets
  ...
  myImager.setSharpenerPercent(20);       // Low sharpener to help distinguish targets
